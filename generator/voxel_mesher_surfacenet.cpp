...
//#define DEBUG_SINGLE_BUILD_MESHS
    ...
    void VoxelMesherSurfaceNets::build(TerrainStruct::MeshOutput &output, const TerrainStruct::MeshInput &input)
    {
    ...
    void VoxelMesherSurfaceNets::build_internal(TerrainStruct::MeshOutput &output, const VoxelBuffer &voxels,
    ...
    void VoxelMesherSurfaceNets::build_internal_with_water(TerrainStruct::MeshOutput &output,
    ...
    void VoxelMesherSurfaceNets::fill_surface_arrays(TerrainStruct::Arrays &arrays)
    {
    ...
    void VoxelMesherSurfaceNets::vertexMesh2outputArrays(
        ...
        TerrainStruct::MeshOutput &output,
        ...
        TerrainStruct::Arrays regular_arrays;
    ...
    void VoxelMesherSurfaceNets::vertexMesh2OutputArrays_with_water(
        ...
        if (nwater_faces_count > 0) {
            ...
            TerrainStruct::Arrays water_arrays;
    ...
    void VoxelMesherSurfaceNets::outputToObjFile(const TerrainStruct::Arrays &singleArray, const Vector3i &position, bool bIsWater) {
