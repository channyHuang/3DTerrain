...
using namespace SURFACE_NETS;
    ...
    public:
        ...
        void build(TerrainStruct::MeshOutput &output, const TerrainStruct::MeshInput &input) override;
    ...
    private:
        ...
        void build_internal(TerrainStruct::MeshOutput &output, const VoxelBuffer &voxels, unsigned int channel, int lod_index,
        ...
        int emit_vertex(const Vector3& primary, const Vector3& normal,
                        ...
                        uint32_t material = 0);
        void clear_output();
        void fill_surface_arrays(TerrainStruct::Arrays &arrays);
        void vertexMesh2outputArrays(
            ...
            const Vector3i &position = Vector3i(0));
        //with water
        void build_internal_with_water(TerrainStruct::MeshOutput &output, const VoxelBuffer &voxels, unsigned int channel, int lod_index,
            const Vector3i &position = Vector3i(0));
        void vertexMesh2OutputArrays_with_water(
            ...
            uint8_t cell_border_mask = 0,
            const Vector3i &position = Vector3i(0));
        void outputToObjFile(const TerrainStruct::Arrays &singleArray, const Vector3i &position, bool bIsWater = false);
